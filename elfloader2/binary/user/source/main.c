...
#define ELF_LOADER_SERVER_IO_PORT 6052
#define ELF_LOADER_SERVER_USER_PORT 6053
#define ELF_LOADER_SERVER_KERNEL_PORT 6054
#define ELF_LOADER_SERVER_KERNEL_PROCESS_PORT 6055
...
int main(int argc, char **argv)
{
	...
	ps4StubResolveSystemCall(4, 1, "another elf loader\n", 19); //print syscall
